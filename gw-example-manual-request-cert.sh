...
certbot certonly --manual --config-dir certbot/config  --work-dir certbot/work --logs-dir certbot/logs --preferred-challenges http --agree-tos -m gary.t.wong@gov.bc.ca -d nmp.apps.nrs.gov.bc.ca -vvvv
